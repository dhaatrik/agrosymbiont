                ...
                <div className="relative z-10">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 justify-center max-w-lg mx-auto relative">
                        ...
                        <button
                            ...
                            className={`bg-cerulean-blue dark:bg-blue-600 text-white font-bold py-4 px-8 rounded-xl transition duration-300 shadow-[0_4px_0_#1e3a8a] dark:shadow-[0_4px_0_#1e40af] hover:shadow-[0_6px_0_#1e3a8a] dark:hover:shadow-[0_6px_0_#1e40af] active:shadow-[0_0px_0_#1e3a8a] dark:active:shadow-[0_0px_0_#1e40af] whitespace-nowrap flex items-center justify-center ${isSubmitting ? 'opacity-75 cursor-not-allowed' : 'hover:bg-blue-700 dark:hover:bg-blue-700 transform hover:-translate-y-1 active:translate-y-1'}`}
                        >
                            {isSubmitting ? (
                                <>
